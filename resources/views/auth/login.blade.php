                        ...
                        <div class="tab-pane fade" id="register" role="tabpanel">
                            <form action="{{ route('register') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="fname" class="form-control" id="registerName" required>
                                </div>

                                <div class="mb-3">
                                    <label for="registerName" class="form-label">Last Name</label>
                                    <input type="text" name="lname" class="form-control" id="registerName" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="phone" class="form-control" id="registerName" required>
                                </div>
