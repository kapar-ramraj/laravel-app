            ...
            <div class="heading">
                <div class="container">
                    <div class="row d-flex justify-content-center text-center">
                        <div class="col-lg-8">
                            <h1>About Us<br></h1>
                            <p class="mb-0">Welcome to Digital Library – your digital gateway to a smarter, faster, and
                                more efficient library experience.</p>
                            <p>At Digital Library, we aim to transform traditional library management by providing a modern,
                                user-friendly system that streamlines book cataloging, borrowing, returning, and member
                                management. Whether you are a librarian, a student, a teacher, or a book lover, our platform
                                is designed to meet your needs with ease and flexibility.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="stats-item text-center w-100 h-100">
                            <span data-purecounter-start="0" data-purecounter-end="{{ $students }}"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="stats-item text-center w-100 h-100">
                            <span data-purecounter-start="0" data-purecounter-end="{{ $books }}"
                                data-purecounter-duration="1" class="purecounter"></span>
                            <p>Books</p>
                        </div>
                    </div><!-- End Stats Item -->
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="stats-item text-center w-100 h-100">
                            <span data-purecounter-start="0" data-purecounter-end="{{ $authors }}"
                                data-purecounter-duration="1" class="purecounter"></span>
                            <p>Authors</p>
                        </div>
                    </div><!-- End Stats Item -->
