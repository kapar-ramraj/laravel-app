                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Edit Role and Assign Permissions</h3>
                            </div>
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form method="POST" action="{{ route('roles.update', $role->id) }}" class="mb-4"
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="permission[]"
                                                            value="{{ $item->name }}" {{ in_array($item->name, $assignedPermissions) ? 'checked' : '' }}>
